...
const Features = () => {
  return (
    <section className="flecCenter overflow-hidden flex-col bg-feature-bg bg-center bg-no-repeat py-24">
...
const FeatureItem = ({ title, icon, description }: FeatureItemProps) => {
  return (
    <li className="flex w-full flex-1 flex-col items-start">
      ...
      <p className="regular-16 mt-5 bg-white/80 text-gray-30 lg:mt-8 lg:bg-none">
        {description}
      </p>
    </li>
  );
